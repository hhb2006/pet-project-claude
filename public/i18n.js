...
const I18N = {
  en: {
    ...
    home_hero_title: "Create a smart diary",
    home_hero_highlight: "for your pet!",
    ...
    home_services_title: "Chat, log, and documents",
    ...
    home_service_docs_title: "Documents & reports",
    home_service_docs_body: "Keep notes, reports, photos, and paperwork with the right pet.",
    home_gallery_eyebrow: "Pet gallery",
    home_gallery_title: "Your pet family",
    home_gallery_intro: "Choose a pet to open their chat, log, and documents.",
  ...
  zh: {
    ...
    home_hero_title: "帮你的宠物做一本",
    home_hero_highlight: "智能日记吧！",
    home_cta_add: "添加你的宠物",
    ...
    home_service_docs_title: "文档与报告",
    home_service_docs_body: "将笔记、报告、照片和文件放在对应宠物的空间中。",
    home_gallery_eyebrow: "宠物画廊",
    home_gallery_title: "你的宠物家人",
    home_gallery_intro: "选择一只宠物，打开它的对话、日志和文档。",
