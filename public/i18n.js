...
const I18N = {
  en: {
    ...
    send: "Send",
    greet: "Tell me about {name} — ask anything, or describe something they did. A review card appears when there is a specific event you may want to record.",
    hint_free: "Chat freely — a detected event is never saved unless you review and confirm it.",
    event_candidate_title: "🐾 Possible log entry",
    event_logged_title: "✓ Recorded",
    event_fallback: "Observed behavior",
    not_now: "Not now",
    complete_and_log: "Review & record",
    view_log: "View",
    manual_add_log: "＋ Add event manually",
    ...
    no_entries_sub: 'Describe an event in Chat, or choose "＋ Add event manually" above.',
  ...
  zh: {
    ...
    send: "发送",
    greet: "和我聊聊 {name} 吧——可以问任何问题，也可以描述它做了什么。发现具体事件时，会出现一张可供确认的记录卡片。",
    hint_free: "随意聊天——识别到的事件只有在你核对并确认后才会保存。",
    event_candidate_title: "🐾 发现一次可记录的行为",
    event_logged_title: "✓ 已记录",
    event_fallback: "观察到的行为",
    not_now: "暂不记录",
    complete_and_log: "完善并记录",
    view_log: "查看",
    manual_add_log: "＋ 手动添加记录",
    ...
    dl_log: "下载日志（JSON）",
    no_entries: "还没有记录。",
    no_entries_sub: "在对话中描述一次事件，或点击上方“＋ 手动添加记录”。",
    confirm_del_entry: "删除这条记录？",
    edit: "编辑",
    edit_hint: "留空表示“未记录”。",
