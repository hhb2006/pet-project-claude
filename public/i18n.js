...
const I18N = {
  en: {
    ...
    breed_no_results: "No matching breeds",
    breed_free_ph: "Breed",
    ...
    avatar_hint: "Optional — stays only in this browser. Pick the original photo or a fun cartoon style.",
    create: "Create",
    no_pets: "No pets yet.",
  ...
  zh: {
    ...
    avatar_cartoon: "卡通版",
    avatar_remove: "移除照片",
    avatar_hint: "可选——仅保存在此浏览器中。可选择原图，或有趣的卡通风格。",
    create: "创建",
    no_pets: "还没有宠物。",
